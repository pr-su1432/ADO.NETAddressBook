...
------stored procedure--------------
CREATE PROCEDURE SP_AddressBook (@FIRSTNAME VARCHAR(50),@LASTNAME VARCHAR(50),@ADDRESSs VARCHAR(100),
@CITY VARCHAR(25),@STATE VARCHAR(50),@ZIP VARCHAR(6),@PHONENO VARCHAR(12),@EMAIL VARCHAR(50))
AS
BEGIN
SET NOCOUNT ON;
INSERT INTO AddressBook([FIRSTNAME],[LASTNAME],[ADDRESSs],[CITY],[STATE],[ZIP],[PHONENO],[EMAIL])
VALUES(@FIRSTNAME,@LASTNAME,@ADDRESSs,@CITY,@STATE,@ZIP,@PHONENO,@EMAIL)
END
GO

EXEC [dbo].[SP_AddressBook] @FIRSTNAME='RAMYA',@LASTNAME='OLETI',@ADDRESSs='25/89',
